    ...
    <footer className="bg-slate-900 text-slate-300 mt-20">
      <div className="max-w-6xl mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-10">
          ...
          {/* Col 2: quick links */}
          <div>
            <h3 className="text-sm font-semibold text-white uppercase tracking-wider mb-4">Links Rápidos</h3>
            <ul className="space-y-2.5 text-sm">
              {[
                ...
                <li key={l.href}>
                  <Link href={l.href} className="text-slate-400 hover:text-violet-400 transition-colors">
                    {l.label}
                  </Link>
                </li>
              ))}
            ...
            <ul className="space-y-2.5 text-sm">
              {categorias.map((c) => (
                <li key={c.id}>
                  <Link
                    href={`/${c.slug}`}
                    className="text-slate-400 hover:text-violet-400 transition-colors flex items-center gap-1.5"
                  >
        ...
        <div className="border-t border-slate-800 pt-6 flex flex-col md:flex-row justify-between gap-2 text-xs text-slate-500">
